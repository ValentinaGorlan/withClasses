...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"]('.page', '.next', 'fadeIn');
  slider.render();
...
/*#__PURE__*/
function () {
  function Slider(page, btns, nextClass, prevClass) {
  ...
  _createClass(Slider, [{
    ...
    value: function showSlides(n) {
      ...
      this.slides[this.slideIndex - 1].classList.add('animated', this.nextClass);
    }
  }, {
    key: "plusSlides",
