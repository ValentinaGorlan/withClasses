...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"]('.form').init();
});
  ...
  _createClass(Difference, [{
    ...
    value: function bindTriggers() {
      ...
      this.officer.querySelector('.plus').addEventListener('click', function () {
        if (_this.counter !== _this.allItems.length - 2) {
          _this.allItems[_this.counter].style.display = 'flex';

          _this.allItems[_this.counter].classList.add('animated', 'fadeIn');

          _this.counter++;
        } else {
          _this.allItems[_this.counter].style.display = 'flex';

          _this.allItems[_this.allItems.length - 1].remove();
        }
      });
    }
  }, {
    ...
    value: function hideItems() {
      this.allItems.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function checkMailInputs() {
      var textInputs = document.querySelectorAll('[type = "email"]');
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      ...
      this.slides[0].classList.add('animated', 'fadeIn'); // for (let i = this.slide[0]; i < this.slides.length; i++) {
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        _this2.slides[0].classList.add('animated', 'fadeIn');
      });
    }
  }, {
    key: "init",
